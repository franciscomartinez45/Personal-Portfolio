        ...
        <div className=" text-headerFontColor w-[95vw] lg:w-[45vw] p-6 text-[clamp(9px,1.4vw,12px)] overflow-hidden">
          ...
          >
            ...
            <ul className="list-disc ml-6 pb-4 ">
              ...
              <li>
                Utilized Python, Pandas, and Pytorch to process large datasets
          ...
          >
            ...
            <p>
              As a Merchandising employee, I have taken multiple roles within
              the company such as Stocker, Cashier, Forklift drive and Meat
              department employee. Within these roles I continued to develop:
            </p>
            <ul className="list-disc ml-6 pb-4 ">
              <li>
                Adaptability by adjusting to different roles and acting swiftly
                to changes of pace throughout the day
              </li>
              <li>
              ...
              <li>
                Leadership skills by identifying and reiterating ways to
                practice efficient standards to my coworkers and enhance day to
                day operational success
              </li>
            </ul>
          </motion.div>
          <motion.div
