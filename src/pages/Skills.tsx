    ...
    <section id="skills" className="section-container text-secondaryText ">
      <div className="flex justify-center ">
        <div className=" flex flex-col justify-center items-center w-[90vw] lg:w-[40vw] justify-self-center">
          ...
          <div className=" text-[clamp(12px,2vw,14px)] border-2 border-borderColor rounded-lg">
            <div className="bg-cardBackground  text-secondaryText justify-center items-center w-[80vw] lg:w-[40vw] justify-self-center p-4 mb-4 rounded-md">
              <h1 className="">
                Throughout my academic career, I have developed highly demanded
                industry skills within the following sections
              </h1>
            </div>
            <div className="bg-cardBackground text-headerFontColor rounded-lg text-secondaryText overflow-hidden grid grid-cols-2 justify-center items-center w-[80vw] lg:w-[40vw] justify-self-center">
              {skills.map((skill) => (
